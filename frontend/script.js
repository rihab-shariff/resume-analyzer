...
document.addEventListener("DOMContentLoaded", () => {
    ...
    analyzeBtn.addEventListener("click", async () => {
        ...
        try {
            // REST API Call
            const response = await fetch("https://resume-analyzer-1-x7jx.onrender.com/api/analyze", {
                method: "POST",
                headers: {
